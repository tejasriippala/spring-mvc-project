...
public class EmpController {
    ...
    public String findAllUser(Model model,@ModelAttribute("Employees")Employees emp){
        List<Employees> employees = empService.findAll();
    ...
    public String save(@ModelAttribute("emp") Employees emp,HttpServletRequest request,HttpServletResponse response) throws ServletException, IOException
    {
        //Table = new newTable();
        try
        {
...
//           view.forward(request, response);
    ...
    public String edit(Model model,Employees emp,@RequestParam int id){
...
//            view.forward(request, response);
    ...
    public void delete(Employees emp,@RequestParam int id,HttpServletRequest request,HttpServletResponse response) throws ServletException, IOException
    {
    ...
    public String searchResult(Model model,Employees emp,@RequestParam int id){
        emp = empService.findById(id);
        System.out.println("Id is :"+ emp.getId());
        model.addAttribute("id", emp.getId());
        model.addAttribute("fname", emp.getFname());
